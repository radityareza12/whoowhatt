            ...
            <div class="col-5">
                ...
                <form method="post" action="" class="mt-4">
                    ...
                    <div class="form-group mt-2">
                        ...
                        <input type="date" id="tgl_pengaduan" name="tgl_pengaduan" class="form-control" readonly>
                    </div>
                    <div class="form-group mt-2">
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col-6">
                            <a class="d-grid btn btn-secondary" href="tablepengaduan.php">
                    ...
                    <div class="row mt-4">
                        <div class="">
                            <a class="d-grid btn btn-secondary" href="index.html">
                                Kembali
                            </a>
                        </div>
                    </div>
